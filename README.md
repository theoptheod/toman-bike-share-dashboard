...
A screenshot of the company's email can be found here:
images/thoman_bike_email_requests.png
...
Two key issues required corrective transformations.
...
image/screeenshot_dashboard_version_b_sheet1
...
A screenshot of the analysis and recommendations can be found here:
image/screeenshot_dashboard_version_b_sheet2
